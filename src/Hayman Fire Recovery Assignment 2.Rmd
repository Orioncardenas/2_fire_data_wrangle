...
There is a positive correlation. Higher moisture and NDVI in unburned, and lower moisture and NDVI in burned.
?spread
```{r}
...
There does not appear to be any correlation between the previous year's snow cover and the vegetation growth in the following year.
``` {r}
...
August has the highest NDVI on average
...
January is the snowiest on average
``` {r}
